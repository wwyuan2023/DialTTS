#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Export Neural Acoustic Model checkpoint."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Export Neural Acoustic Generator (See detail in dialtts/acoustic/bin/export.py).")
    ...
    if args.convert != 0:
        ...
        dummy_input = [
            ...
            torch.zeros(batch_size, 1, config["num_text"]),
        ]
