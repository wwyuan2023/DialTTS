...
class SegText(object):
    ...
    def get_lang(self, idx: int, lang=Lang.CN):
        if -len(self.segtext) <= idx < len(self.segtext):
            return self.segtext[idx][3]
        return lang
